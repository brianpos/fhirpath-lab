...
export const Dosage: TypeModel = {
    ...
    Elements: [
        ...
        { ElementName: "maxDosePerPeriod", Type: [{ TypeName: "Ratio" }], IsArray: true },
...
export const RelatedArtifact: TypeModel = {
    ...
    Elements: [
        ...
        { ElementName: "publicationStatus", Type: [{ TypeName: "code" }] },
        { ElementName: "publicationDate", Type: [{ TypeName: "date" }] },
    ],
};
