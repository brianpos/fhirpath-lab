...
export const requestFhirAcceptHeaders = "application/fhir+json; fhirVersion=4.0, application/fhir+json, application/json";
export const requestFhirXmlAcceptHeaders = "application/fhir+xml; fhirVersion=4.0, application/fhir+xml, text/xml, application/xml";
