...
export function renderFmlInstanceDiagram(fmlText: string): string {
    ...
    if ("resourceType" in parsed && parsed.resourceType === "OperationOutcome") {
    ...
    return generateInstanceDiagramSvg(
        fmlToStructureMapForDiagram(parsed),
        lookupByTypeNameR4B,
        true,
