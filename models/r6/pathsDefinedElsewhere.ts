export const pathsDefinedElsewhere = {
  ...
  "ClinicalUseDefinition.indication.otherTherapy": "ClinicalUseDefinition.contraindication.otherTherapy",
  ...
  "MedicationKnowledge.packaging.cost": "MedicationKnowledge.cost",
  ...
  "StructureMap.group.rule.dependent.parameter": "StructureMap.group.rule.target.parameter",
  ...
  "TestPlan.testCase.testCase": "TestPlan.testCase",
  ...
  "TestScript.common.action.assert": "TestScript.setup.action.assert",
  "TestScript.common.action.operation": "TestScript.setup.action.operation",
  "TestScript.teardown.action.common": "TestScript.setup.action.common",
  ...
  "TestScript.test.action.common": "TestScript.setup.action.common",
